...
Copyright
    ...
    bash_env is distributed in the hope that it will be useful, but
...
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'bash_env.tex', 'ats\\_utilities Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'bash_env', 'bash_env Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'bash_env', 'bash_env Documentation',
